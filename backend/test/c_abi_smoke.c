...
int main(void) {
    ...
    assert(VIVI_BACKEND_EVENT_COMMAND_CATALOG == 22);
    assert(VIVI_BACKEND_EVENT_COMMAND_CATALOG_FAILURE == 23);
    assert(VIVI_BACKEND_EVENT_COMMAND_COMPLETED == 24);
    assert(VIVI_BACKEND_EVENT_COMMAND_FAILED == 25);
